...
Capacities = CSV.read(string(inputs_path_plots,sep,"capacity_RN_co2_cap.csv"), DataFrame, header=true)
...
Plots.savefig(Grouped_barPlot_Cap,"Results/Plots_with_zones/grouped_Cap_with_zones_RN_CO2_Cap.pdf")


#Plotting Flows
Flows_plt = CSV.read(string(inputs_path_plots,sep,"Transmission_Flows_RN_co2_cap.csv"), DataFrame, header=true)
...
Plots.savefig(Combined_Plots_flow,"Results/Plots_with_zones/Transmission_flow_combined.pdf")


#Plotting emissions
Emission_per_zone = CSV.read(string(inputs_path_plots,sep,"emissions_per_zone_D_co2_cap.csv"), DataFrame, header=true)
em_zone = zeros(Z)
for i in 1:Z
...
Plots.savefig(plt_Emission_zone,"Results/Plots_with_zones/Emissions_per_zone.pdf")


#Plotting generation
Generation_z1 = CSV.read(string(inputs_path_plots,sep,"generation_z1_CN_RN_co2_cap.csv"), DataFrame, header=true)
Generation_z2 = CSV.read(string(inputs_path_plots,sep,"generation_z2_SK_RN_co2_cap.csv"), DataFrame, header=true)
Generation_z3 = CSV.read(string(inputs_path_plots,sep,"generation_z3_GB_RN_co2_cap.csv"), DataFrame, header=true)
Gen_all = zeros(R,Z)
for i in 1:R
...
Plots.savefig(Grouped_barplt_gen,"Results/Plots_with_zones/Generation_per_zone.pdf")

#Plotting Revenues
Revenues_all_zones = CSV.read(string(inputs_path_plots,sep,"revenue_RN_co2_cap.csv"), DataFrame, header=true)
...
Plots.savefig(Grouped_barplt_rev,"Results/Plots_with_zones/Revenue_per_zone.pdf")


#Plotting Power Price
Price_all_zones = CSV.read(string(inputs_path_plots,sep,"price_RN_co2_cap.csv"), DataFrame, header=true)
...
charge_for_plt = CSV.read(string(inputs_path_plots,sep,"charge_RN_co2_cap.csv"), DataFrame, header=true)
discharge_for_plt = CSV.read(string(inputs_path_plots,sep,"discharge_RN_co2_cap.csv"), DataFrame, header=true)
